...
class ConfigPaths:
    ...
    verification_config: str = "verification/config/verification_config.yaml"
    workflow_config: str = "verification/config/workflow_config.yaml"
    prompts_config: str = "verification/config/prompts.yaml"
    environment_dir: str = "verification/config/environments"

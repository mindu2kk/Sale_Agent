...
class LoggingConfigurator:
    ...
    def setup_logging(self, environment: Optional[str] = None) -> None:
        ...
        logger = self.get_logger("backend.verification.setup")
    ...
    def _load_logging_config(self, environment: str) -> Dict[str, Any]:
        ...
        config_paths = [
            f"backend/verification/config/environments/{environment}.yaml",
            "backend/verification/config/logging_config.yaml",
            "backend/verification/config/verification_config.yaml"
        ]
    ...
    def create_workflow_logger(self, workflow_id: str) -> EnhancedVerificationLogger:
        ...
        logger_name = f"backend.verification.workflow.{workflow_id}"
...
def get_verification_logger(component: str = "verification") -> EnhancedVerificationLogger:
    ...
    configurator = get_logging_configurator()
    return configurator.get_logger(f"backend.verification.{component}")

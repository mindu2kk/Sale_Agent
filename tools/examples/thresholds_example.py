...
# The example deliberately prints Vietnamese text and Unicode symbols.  On
# Windows, a legacy console may default to cp1252 and fail before the example
# can finish, so prefer UTF-8 when the active text stream supports it.

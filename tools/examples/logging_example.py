...
from backend.verification.config.config import VerificationConfig, LogLevel
...
def correlation_tracking_example():
    ...
    configurator = setup_verification_logging("development")
    logger = configurator.get_logger("backend.verification.correlation")
...
def workflow_observability_example():
    ...
    configurator = setup_verification_logging("development")
    logger = configurator.get_logger("backend.verification.workflow")
...
def error_handling_example():
    ...
    configurator = setup_verification_logging("development")
    logger = configurator.get_logger("backend.verification.errors")
...
def performance_monitoring_example():
    ...
    configurator = setup_verification_logging("development")
    logger = configurator.get_logger("backend.verification.performance")
...
async def async_logging_example():
    ...
    configurator = setup_verification_logging("development")
    logger = configurator.get_logger("backend.verification.async")
...
def comprehensive_example():
    ...
    configurator = setup_verification_logging("development")
    logger = configurator.get_logger("backend.verification.comprehensive")
    ...
    with workflow_context(workflow_id, logger):
        with correlation_context(correlation_id=correlation_id):
            ...
            try:
                # Research phase
                logger.log_node_execution("research", "running", 0.0)
                ...
                # Verification phase
                logger.log_node_execution("verification", "running", 0.0)
                ...
                # Completion
                logger.log_node_execution("completion", "running", 0.0)
                logger.log_workflow_end(workflow_id, "completed", 1.0)
